...
import com.dingar.twok.core.R;

import java.util.Objects;

public class OTPEdittext extends AppCompatEditText {
    private float mSpace = 7; //24 dp by default, space between the lines
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLinesPaint.setColor(getResources().getColor(R.color.cardview_dark_background));
