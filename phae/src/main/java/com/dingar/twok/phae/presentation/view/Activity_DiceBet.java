...
public class Activity_DiceBet extends AppCompatActivity implements DiceBetContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phae_bet);

        //initiate the login component and inject the view
        phaeBetComponent = ((ComponentProviderPhae)getApplicationContext())
                .providePhaeBetComponent();
        phaeBetComponent.inject(this);
